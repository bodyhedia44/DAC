                ...
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-16 mb-1">اهلا بك في موقعنا</h4>
                            <p class="text-muted mb-0">ماذا نستطيع ان نقدم لك اليوم</p>
                        </div>
...
{{--                </div>--}}
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">تقرير المبيعات اخر 24 ساعة</h4>
                        </div><!-- end card header -->
