                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="{{ URL::asset('assets/logo.png')}}" alt="" height="75">
                            </a>
                        </div>
                        <p class="mt-3 fs-15 fw-medium">DAC POS Management System</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to DAC.</p>
                            </div>
                            <div class="p-2 mt-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> DAC. Crafted with <i class="mdi mdi-heart text-danger"></i> <a href="https://twitter.com/hedia_body" target="_blank">HEDIA</a></p>
                    </div>
                </div>
            </div>
        </div>
